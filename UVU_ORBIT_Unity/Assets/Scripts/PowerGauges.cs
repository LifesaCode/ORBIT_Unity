...
public class PowerGauges : MonoBehaviour
{
    ...
    SpriteRenderer[] batteryChargeImages;
	SpriteRenderer[] solarFill;
    ...
    void Start()
    {
		...
		solarFill = SolarArrayFill.GetComponentsInChildren<SpriteRenderer>();
        batteryChargeImages = BatteryChargeImages.GetComponentsInChildren<SpriteRenderer>();
    ...
    void ChangeOpacity(SpriteRenderer panel, float opacity)
    {
        Color c = panel.color;
        c.a = opacity;
        panel.color = c;
